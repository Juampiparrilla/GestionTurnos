...
- **Actualizar costos**: buscá o filtrá (mismos filtros que Reportes) para encontrar los productos, tildalos a mano -- de a uno o todos los visibles con un botón, la selección se mantiene entre búsquedas -- y aplicales de una un % de aumento o baja sobre el costo actual, por ejemplo cuando un proveedor sube toda su lista un 15%. Las tres pistas de precio se recalculan solas con el % de ganancia que ya tenía cada una, sin tocar las fijadas manualmente.
