...
export function ProductoFiltrosPanel({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg border border-zinc-300 bg-zinc-100 max-md:border-input max-md:bg-muted p-3 dark:border-zinc-700 dark:bg-zinc-800">
