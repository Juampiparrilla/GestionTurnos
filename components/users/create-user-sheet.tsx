...
export function CreateUserSheet({
  ...
  const [invitation, setInvitation] = useState<{ url: string; fullName: string } | null>(null);
  ...
  async function handleSubmit(formData: FormData) {
    ...
    setIsSubmitting(false);
    onOpenChange(false);
    setInvitation({ url: data.invitationUrl, fullName: data.fullName });
  }
      ...
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent side="right" className="w-full sm:max-w-md">
          <SheetHeader>
            ...
            <SheetDescription>
              Vas a recibir un enlace de invitación para compartir por WhatsApp.
            </SheetDescription>
          </SheetHeader>
